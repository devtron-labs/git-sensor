...
[![GoDoc](https://godoc.org/github.com/devtron-labs/go-git?status.svg)](https://pkg.go.dev/github.com/devtron-labs/go-git) [![Build Status](https://github.com/go-git/go-git/workflows/Test/badge.svg)](https://github.com/go-git/go-git/actions) [![Go Report Card](https://goreportcard.com/badge/github.com/go-git/go-git)](https://goreportcard.com/report/github.com/go-git/go-git)

*go-git* is a highly extensible git implementation library written in **pure Go**.

It can be used to manipulate git repositories at low level *(plumbing)* or high level *(porcelain)*, through an idiomatic Go API. It also supports several types of storage, such as in-memory filesystems, or custom implementations, thanks to the [`Storer`](https://pkg.go.dev/github.com/devtron-labs/go-git/plumbing/storer) interface.
...
```go
import "github.com/devtron-labs/go-git" // with go modules enabled (GO111MODULE=on or outside GOPATH)
