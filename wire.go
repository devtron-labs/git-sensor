...
func InitializeApp() (*App, error) {
	...
	wire.Build(
		...
		git.NewGoGitManagerImpl,
		wire.Bind(new(git.GoGitManager), new(*git.GoGitManagerImpl)),
		git.NewCliGitManagerImpl,
		wire.Bind(new(git.CliGitManager), new(*git.CliGitManagerImpl)),
